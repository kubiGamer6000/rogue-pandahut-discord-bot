...
bot.on('message', (msg) => {
	...
	if (msg.content.includes('nigga') || msg.content.includes('negro') || msg.content.includes('african american')) {
		msg.channel.send(`<@${msg.author.id}> no racism`).then((msg) => {
			setTimeout(() => {
				msg.delete();
			}, 3000);
		});
